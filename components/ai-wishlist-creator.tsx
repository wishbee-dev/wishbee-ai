      ...
      <Card className="border-2 border-[#F4C430] shadow-2xl">
        <CardContent className="p-6 md:p-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <Sparkles className="w-8 h-8 text-[#F4C430] animate-pulse" />
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Add to Wishlist</h2>
              <p className="text-sm text-gray-600">Just paste a link - AI handles the rest</p>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                  <LinkIcon className="w-4 h-4 text-[#F4C430]" />
              ...
              <Button
                ...
                className="w-full py-4 rounded-xl font-semibold text-lg bg-gradient-to-r from-[#DAA520] to-[#F4C430] text-[#8B4513] hover:from-[#F4C430] hover:to-[#DAA520] shadow-lg hover:shadow-xl transition-all"
              >
                {isProcessing ? (
                  <>
            ...
            <div className="space-y-6 animate-in fade-in-50 slide-in-from-bottom-5 duration-500">
              ...
              <div className="p-4 bg-purple-50 border-2 border-purple-200 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800 mb-1">AI Smart Insights</h4>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ol className="list-decimal list-inside space-y-1">
                    <li>Paste any product link or type what you want</li>
                    <li>AI extracts all details automatically (image, price, description, etc.)</li>
                    <li>Review and save - your item is ready for funding!</li>
                  </ol>
                </div>
              </div>
            </div>
