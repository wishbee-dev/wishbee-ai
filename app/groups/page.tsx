      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
              ...
              <p className="text-[#8B4513]/80">Manage your gifting groups with AI insights</p>
            </div>
            <Link
              href="/groups/create"
              className="w-44 sm:w-48 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-[#DAA520] to-[#F4C430] text-[#3B2F0F] rounded-full font-semibold hover:shadow-lg transition-all text-xs sm:text-sm text-center"
            >
              Create Group
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            >
              <div className="p-2 bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 rounded-lg">
            ...
            <div className="flex items-center gap-3 p-4 bg-white rounded-lg border-2 border-[#DAA520]/20">
              <div className="p-2 bg-gradient-to-br from-[#DAA520] to-[#F4C430] rounded-lg">
        ...
        {upcomingOccasions && upcomingOccasions.upcomingOccasions?.length > 0 && (
          <div className="mb-8 p-6 bg-gradient-to-r from-[#DAA520]/10 to-[#F4C430]/10 rounded-xl border-2 border-[#DAA520]/30">
            <h2 className="text-xl font-bold text-[#654321] mb-4 flex items-center gap-2">
              ...
              {upcomingOccasions.upcomingOccasions.slice(0, 3).map((occasion: any, index: number) => (
                <div key={index} className="bg-white p-4 rounded-lg border border-[#DAA520]/20">
                  ...
                  <button
                    ...
                    className="w-full px-3 py-1.5 bg-gradient-to-r from-[#DAA520] to-[#F4C430] text-[#3B2F0F] rounded-lg text-xs font-semibold hover:shadow-lg transition-all"
                  >
          ...
          {groups.map((group) => (
            <div key={group.id} className="bg-white rounded-xl shadow-lg border-2 border-[#DAA520]/20 p-6">
              ...
              <Link
                ...
                className="w-full px-4 py-2 bg-gradient-to-r from-[#DAA520] to-[#F4C430] text-[#3B2F0F] rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center"
              >
                View Group
              </Link>
            </div>
