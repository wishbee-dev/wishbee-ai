    ...
    >
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8 text-center">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">My Wishlist</h1>
          <p className="text-base md:text-base lg:text-lg text-gray-600">View and manage your saved wishlist items</p>
        </div>
