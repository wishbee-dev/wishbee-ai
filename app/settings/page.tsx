            ...
            <div id="account" className="bg-white rounded-xl shadow-lg border-2 border-[#DAA520]/20 p-4 sm:p-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <button
                  ...
                  disabled={isSaving}
                  className="flex items-center justify-center gap-1 sm:gap-2 px-3 py-1.5 sm:px-6 sm:py-2 bg-gradient-to-r from-[#DAA520] to-[#F4C430] text-[#3B2F0F] rounded-lg text-[10px] sm:text-base font-semibold hover:shadow-lg transition-all disabled:opacity-50 w-full sm:w-auto mx-auto"
                >
                  {isSaving ? (
                    <>
                      <Loader2 className="w-2.5 h-2.5 sm:w-4 sm:h-4 animate-spin" />
