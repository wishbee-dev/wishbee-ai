      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {activeGifts.map((gift) => (
            ...
            >
              ...
              <h3 className="text-base sm:text-lg font-bold text-[#654321] mb-3">{gift.name}</h3>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2 md:gap-4">
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 text-white rounded-lg text-xs sm:text-sm font-semibold hover:shadow-lg transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 whitespace-nowrap"
                  >
        ...
        <div className="mt-12">
          ...
          <div className="mb-6 flex flex-row items-center justify-center gap-2">
            ...
            <h2 className="text-sm sm:text-2xl md:text-3xl font-bold text-[#654321] whitespace-nowrap">
              Recommended Gifts to Purchase
            </h2>
          </div>
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-grow">
                  <div className="mb-2 flex-shrink-0">
                    <span className="text-xs bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 px-2 py-1 rounded-full font-semibold truncate block max-w-full">
                      For: {product.forGift}
                    </span>
                  </div>
                  ...
                  <div className="h-12 mb-2 flex-shrink-0">
                    <h3 className="font-bold text-sm text-[#654321] line-clamp-2 leading-tight">{product.name}</h3>
                  </div>
                  ...
                  <div className="space-y-2 flex-shrink-0">
                    <button
                      ...
                      className="w-full px-3 py-2 bg-gradient-to-r from-[#DAA520] to-[#F4C430] text-white rounded-lg text-sm font-semibold hover:shadow-lg transition-all hover:scale-105 flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 border-2 border-[#DAA520] text-[#8B5A3C] rounded-lg text-sm font-semibold hover:bg-[#DAA520]/10 transition-all"
                    >
                      Add to Cart
                    </button>
                  </div>
