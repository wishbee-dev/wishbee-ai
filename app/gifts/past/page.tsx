    ...
    <div className="min-h-screen bg-[#F5F1E8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="bg-card border border-border rounded-lg p-6 mb-8">
            <div className="flex flex-row items-center justify-center gap-2">
              <CheckCircle className="w-5 h-5 sm:w-8 sm:h-8 md:w-10 md:h-10 text-emerald-600 flex-shrink-0" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-4 border-2 border-purple-500/20">
            <div className="flex items-center gap-3">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pastGifts.map((gift) => (
            <div
              key={gift.id}
              className="bg-white rounded-xl shadow-lg border-2 border-emerald-500/20 p-6 hover:shadow-xl transition-shadow"
            >
              <div className="relative mb-4">
                ...
                />
                <div className="absolute top-2 right-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg">
              ...
              <div className="space-y-2">
                <Link
                  ...
                  className="block w-full px-3 py-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-lg text-xs sm:text-sm font-semibold hover:shadow-lg transition-all text-center"
                >
                  View Details
                </Link>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-2 border-2 border-emerald-500 text-[#8B5A3C] rounded-lg text-xs sm:text-sm font-semibold hover:bg-emerald-50 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 px-3 py-2 border-2 border-[#DAA520] text-[#8B5A3C] rounded-lg text-xs sm:text-sm font-semibold hover:bg-[#F5F1E8] transition-all flex items-center justify-center gap-2"
                  >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="w-16 sm:w-20 md:w-24 px-2 sm:px-3 py-2 border-2 border-amber-500 text-[#8B5A3C] rounded-lg text-xs sm:text-sm font-semibold hover:bg-amber-50 transition-all flex items-center justify-center"
                  >
